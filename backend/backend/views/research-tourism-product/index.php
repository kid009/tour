...
GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'format' => 'raw',
            'value' => function ($data) {
                $url = "@web/uploads/research" . '/product/' . $data->researcher_tourism_product_image_cover;
                return Html::img($url, ['style' => 'height:100px;weidth:100px;']);
            },
        ], //image

        // [
        //     'attribute' => 'researcher_tourism_product_group_id',
        //     'header' => 'กลุ่มผลิตภัณฑ์',
        //     'value' => function ($model) {
        //         return $model->researchTourismProductGroup->researcher_tourism_product_group_name;
        //     },
        // ],
        [
        ...
        [
            'attribute' => 'researcher_tourism_product_name_en',
            'header' => 'ชื่อภาษาอังกฤษ',
            'value' => function ($model) {
                return $model->researcher_tourism_product_name_en;
            },
        ],
        ...
        [
            ...
            'value' => function ($data) {
                $url = Url::to([
                    'research-image/tourism-product-index',
                    'researcher_tourism_product_id' => $data->researcher_tourism_product_id,
                ]);
        ...
        [
            ...
            'buttons' => [
                'delete' => function ($url, $model, $key) {
                    return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->researcher_tourism_product_id], [
