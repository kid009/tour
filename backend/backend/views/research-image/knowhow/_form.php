...
if ($model->isNewRecord) { //เพิ่มข้อมูลใหม่
    ...
    echo Html::img('@web/uploads/research/knowhow/' . $model->research_image_file, ['style' => 'width:100px;height:100px;']);
    echo '<hr>';
    echo $form->field($model, 'research_image_file')->widget(FileInput::className(), [
        'options' => [
            'accept' => 'image/*',
...
<div class="pull-right">
    ...
    <a href="<?= Url::to(['research-image/knowhow-index', 'researcher_knowhow_id' => $researcher_knowhow_id]); ?>" class="btn btn-danger">
        ยกเลิก
    </a>
</div>
