            ...
            echo GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            $url = "@web/uploads/beststudy/" . $data->best_study_image_cover;
                    ...
                    [
                        'attribute' => 'best_study_name',
                        'header' => 'Best Study Name',
                        'value' => function ($model) {
                            return $model->best_study_name;
                        }
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->best_study_id], [
