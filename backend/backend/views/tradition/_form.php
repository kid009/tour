...
<div class="row setup-content" id="step-1">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'tradition_name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true]) ?>

            <?= $form->field($model, 'tradition_name_en', ['enableAjaxValidation' => true])->textInput(['maxlength' => true]) ?>
            ...
            ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?= $form->field($model, 'tradition_image_cover')->widget(FileInput::className(), [
                            'options' => [
                                'accept' => 'image/*',
                                'pluginOptions' => [
                                    'showUpload' => FALSE,
            ...
            ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-3">
                            <?= Html::img('@web/uploads/community/' . $model->community_id . '/tradition/' . $model->tradition_image_cover, ['style' => 'height:100px;weidth:100px;']) ?>
                            <br><br>
                        </div>
                        <div class="col-md-9">
                            <?php
                            echo $form->field($model, 'tradition_image_cover')->widget(FileInput::className(), [
                                'options' => [
                                    'accept' => 'image/*',
                                    'pluginOptions' => [
                                        'showUpload' => false,
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class='col-md-6'>
                            <?= $form->field($model, 'tradition_start_date')->widget(DateTimePicker::className(), [
                                'name' => 'tradition_start_date',
                                'options' => ['placeholder' => 'เริ่มต้นกิจกรรม...'],
                                'pluginOptions' => [
                        ...
                        <div class='col-md-6'>
                            <?= $form->field($model, 'tradition_end_date')->widget(DateTimePicker::className(), [
                                'name' => 'tradition_end_date',
                                'options' => ['placeholder' => 'สิ้นสุดกิจกรรม...'],
                                'pluginOptions' => [
                                    'format' => 'yyyy-mm-dd h:i:s',
                                    'todayHighlight' => true
                                ]
            ...
            <?= $form->field($model, 'tradition_place')->textInput(['maxlength' => true])->label('สถานที่') ?>
                    ...
                    <div class="col-md-4">
                        ...
                        $form->field($model, 'tambon_id')->widget(DepDrop::classname(), [
                            ...
                            'pluginOptions' => [
                                ...
                                'url' => Url::to(['/tradition/get-tambon'])
                            ]
                        ])->label('ตำบล')
                        ?>
                    </div>
                    <div class="col-md-4">
                        ...
                        $form->field($model, 'amphur_id')->widget(DepDrop::classname(), [
                            ...
                            'pluginOptions' => [
                                ...
                                'url' => Url::to(['/tradition/get-amphur']),
                            ],
                        ])->label('อำเภอ')
                        ?>
                    </div>
...
<div class="row setup-content" id="step-3">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'tradition_detail')->widget(CKEditor::className(), [
                'options' => ['row' => 3],
                'preset' => 'standard',
            ])->label('รายละเอียด') ?>

            <?= $form->field($model, 'tradition_detail_en')->widget(CKEditor::className(), [
                'options' => ['row' => 3],
                'preset' => 'standard',
...
<div class="row setup-content" id="step-4">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'tradition_information')->widget(CKEditor::className(), [
                'options' => ['row' => 3],
                'preset' => 'standard',
            ...
            <div class="pull-right">
                ...
                <a href="<?= Url::to(['tradition/index']); ?>" class="btn btn-danger">
                    ยกเลิก
                </a>
            </div>
