...
<div class="stepwizard col-md-offset-3" style="margin-top: 10px;">
    <div class="stepwizard-row setup-panel">
        ...
        <div class="stepwizard-step">
            ...
            <p>ข้อมูลเรื่องราว<br>จากการท่องเที่ยว</p>
        </div>
...
<div class="row setup-content" id="step-1">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'tourism_story_name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true])->label('ชื่อ') ?>

            <?= $form->field($model, 'tourism_story_name_en')->textInput(['maxlength' => true])->label('ชื่อภาษาอังกฤษ') ?>

            <?= $form->field($model, 'tourism_story_place')->textInput(['maxlength' => true])->label('สถานที่') ?>
...
<div class="row setup-content" id="step-2">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'tourism_story_detail')->widget(CKEditor::className(), [
                'options' => ['rows' => 3],
                'preset' => 'standard',
            ])->label('รายละเอียดภาษาไทย') ?>

            <?= $form->field($model, 'tourism_story_detail_en')->widget(CKEditor::className(), [
                'options' => ['rows' => 3],
                'preset' => 'standard',
        ...
        <div class="col-md-12">
            ...
            ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?= $form->field($model, 'tourism_story_image_cover')->widget(FileInput::className(), [
                            'options' => [
                                'accept' => 'image/*',
                                'pluginOptions' => [
                                    'showUpload' => false,
            ...
            ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-3">
                            <?= Html::img('@web/uploads/tourism/story/' . $model->tourism_story_image_cover, ['style' => 'height:100px;weidth:100px;']) ?>
                            <br><br>
                        </div>
                        <div class="col-md-9">
                            <?php
                            echo $form->field($model, 'tourism_story_image_cover')->widget(FileInput::className(), [
                                'options' => [
                                    'accept' => 'image/*',
                                    'pluginOptions' => [
                                        'showUpload' => false,
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <?= $form->field($model, 'tourism_story_vdo')->textInput()->label('ลิงค์วีดีโอ') ?>

                    <?= $form->field($model, 'tourism_story_link')->textInput()->label('ลิงค์') ?>
