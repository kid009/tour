...
<div class="panel panel-default" style="margin-top: 20px;">
    ...
    <div class="panel-body">
        ...
        if ($model->isNewRecord) { //เพิ่มข้อมูลใหม่
            ...
            echo Html::img('@web/uploads/community/' . $model->community_id . '/nature/' . $model->community_image_file, ['style' => 'width:100px;height:100px;']);
            echo '<br><br>';
            echo $form->field($model, 'community_image_file')->widget(FileInput::className(), [
                'options' => [
                    'accept' => 'image/*',
        ...
        <div class="pull-right">
            ...
            <a href="<?= Url::to(['community-image/nature-index', 'com_id' => $community->community_id, 'nature_id' => $nature_id]); ?>" class="btn btn-danger">
                ยกเลิก
            </a>
        </div>
