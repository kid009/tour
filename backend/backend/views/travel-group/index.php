        ...
        <div class="table-responsive">
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'travel_group_name',
                        'header' => 'ชื่อกลุ่ม',
                        'value' => function ($model) {
                            return $model->travel_group_name;
                        }
                    ],
                    [
                        'attribute' => 'travel_group_name_en',
                        'header' => 'ชื่อภาษาอังกฤษ',
                        'value' => function ($model) {
                            return $model->travel_group_name_en;
                        }
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->travel_group_id], [
