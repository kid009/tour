...
$this->title = 'กลุ่มสถานที่ที่เกี่ยวข้อง';
        ...
        <div class="table-responsive">
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'poi_group_name',
                        'header' => 'ชื่อกลุ่ม',
                        'value' => function ($model) {
                            return $model->poi_group_name;
                        }
                    ],
                    [
                        'attribute' => 'poi_group_name_en',
                        'header' => 'ชื่อภาษาอังกฤษ',
                        'value' => function ($model) {
                            return $model->poi_group_name_en;
                        }
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->poi_group_id], [
