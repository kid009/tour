...
$this->title = 'กิจกรรมในสถานที่ประวัติศาสตร์';
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function($url, $model, $key) {
                            return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->activity_place_id], [
