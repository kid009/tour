        ...
        <div class="table-responsive">
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    //'culture_group_name',
                    [
                        'attribute' => 'culture_group_name',
                        'header' => 'ชื่อกลุ่ม',
                        'value' => function ($model) {
                            return $model->culture_group_name;
                        }
                    ],

                    [
                        'attribute' => 'culture_group_name_en',
                        'header' => 'ชื่อกลุ่มภาษาอังกฤษ',
                        'value' => function ($model) {
                            return $model->culture_group_name_en;
                        }
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->culture_group_id], [
