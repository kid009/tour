...
<div class="panel panel-default" style="margin-top: 20px;">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <h3>ผลิตภัณฑ์ชุมชน : <?php echo $model->bussiness_product_community_name ?></h3>
            </div>

            <div class="col-md-3" style="margin-top:20px;">
                <p style="text-align:right">
                    <a href="<?php echo Url::to(['bussiness-product-community/image-create', 'id' => $model->bussiness_product_community_id]); ?>" class="btn btn-success">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="pull-right">
                                ...
                                <a class="btn btn-warning" href="<?php echo Url::to([
                                    'bussiness-product-community/image-update', 
                                    'id' => $model->bussiness_product_community_id, 
                                ...
                                <a class="btn btn-danger" href="<?php echo Url::to([
                                    'bussiness-product-community/image-delete', 
                                    'id' => $model->bussiness_product_community_id, 
                                    'bussiness_image_id' => $values['bussiness_image_id']
                                ]); 
