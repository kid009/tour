...
<div class="row setup-content" id="step-1">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'bussiness_product_community_name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true])->label('ชื่อ') ?>

            <?= $form->field($model, 'bussiness_product_community_name_en')->textInput(['maxlength' => true])->label('ชื่อภาษาอังกฤษ') ?>

            <?= $form->field($model, 'bussiness_product_community_story')->widget(CKEditor::className(), [
                'options' => ['rows' => 3],
                'preset' => 'standard',
            ])->label('เรื่องราว') ?>
...
<div class="row setup-content" id="step-2">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'bussiness_product_community_detail')->widget(CKEditor::className(), [
                'options' => ['rows' => 3],
                'preset' => 'standard',
            ])->label('รายละเอียดภาษาไทย') ?>

            <?= $form->field($model, 'bussiness_product_community_detail_en')->widget(CKEditor::className(), [
                'options' => ['rows' => 3],
                'preset' => 'standard',
...
<div class="row setup-content" id="step-3">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'bussiness_product_community_price')->textInput(['type' => 'number'])->label('ราคา (บาท) *ใส่เฉพาะตัวเลข') ?>

            <?= $form->field($model, 'bussiness_product_community_promotion')->widget(CKEditor::className(), [
                'options' => ['rows' => 3],
                'preset' => 'standard',
            ])->label('โปรโมชั่น') ?>
        ...
        <div class="col-md-12">
            ...
            ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?= $form->field($model, 'bussiness_product_community_image_cover')->widget(FileInput::className(), [
                            'options' => [
                                'accept' => 'image/*',
                                'pluginOptions' => [
                                    'showUpload' => false,
            ...
            ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-3">
                            <?= Html::img('@web/uploads/bussiness/product_community/' . $model->bussiness_product_community_image_cover, ['style' => 'height:100px;weidth:100px;']) ?>
                            <br><br>
                        </div>
                        <div class="col-md-9">
                            <?php
                            echo $form->field($model, 'bussiness_product_community_image_cover')->widget(FileInput::className(), [
                                'options' => [
                                    'accept' => 'image/*',
                                    'pluginOptions' => [
                                        'showUpload' => false,
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <?= $form->field($model, 'bussiness_product_community_vdo')->textInput()->label('ลิงค์วีดีโอ') ?>

                    <?= $form->field($model, 'bussiness_product_community_link')->textInput()->label('ลิงค์') ?>
            ...
            <div class="pull-right">
                ...
                <a href="<?= Url::to(['bussiness-product-community/index']); ?>" class="btn btn-danger">
                    ยกเลิก
                </a>
            </div>
