...
$this->title = 'กิจกรรมเส้นทางท่องเที่ยว';
    ...
    <div class="panel-body">
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'tourism_sub_route_id',
                    'value' => function($model) {
                        return $model->tourismSubRoute->tourism_sub_route_name;
                    }
                ],
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function($url, $model, $key) {
                            return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->tourism_sub_route_activity_id], [
