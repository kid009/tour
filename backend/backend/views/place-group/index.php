...
$this->title = 'กลุ่มสถานที่ประวัติศาสตร์';
...
<div class="table-responsive">
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'place_group_name',
                    'header' => 'ชื่อกลุ่ม',
                    'value' => function($model) {
                        return $model->place_group_name;
                    }
                ],
                [
                    'attribute' => 'place_group_name_en',
                    'header' => 'ชื่อกลุ่มภาษาอังกฤษ',
                    'value' => function($model) {
                        return $model->place_group_name_en;
                    }
                ],
                [
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function($url, $model, $key) {
                            return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->place_group_id], [
