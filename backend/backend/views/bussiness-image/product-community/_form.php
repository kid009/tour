...
if ($model->isNewRecord) { //เพิ่มข้อมูลใหม่
    ...
    echo Html::img('@web/uploads/bussiness/product_community/' . $model->bussiness_image_file, ['style' => 'width:100px;height:100px;']);
    echo '<hr>';
    echo $form->field($model, 'bussiness_image_file')->widget(FileInput::className(), [
        'options' => [
            'accept' => 'image/*',
...
<div class="pull-right">
    ...
    <a href="<?=Url::to(['bussiness-image/product-community-index', 'bussiness_product_community_id' => $bussiness_product_community_id]);?>" class="btn btn-danger">
        ยกเลิก
    </a>
</div>
