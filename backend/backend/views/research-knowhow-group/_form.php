...
<div class="row setup-content" id="step-1">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?=$form->field($model, 'researcher_knowhow_group_name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true])->label('ชื่อ')?>

            <?=$form->field($model, 'researcher_knowhow_group_name_en')->textInput(['maxlength' => true])->label('ชื่อภาษาอังกฤษ')?>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?=
$form->field($model, 'researcher_knowhow_group_name_detail')->widget(CKEditor::className(), [
    'options' => ['row' => 6],
    'preset' => 'basic',
])->label(false)
?>
                ...
                <div class="panel-body">
                    ...
                    <?php
echo $form->field($model, 'researcher_knowhow_group_name_detail_en')->widget(CKEditor::className(), [
    'options' => ['row' => 6],
    'preset' => 'basic',
])->label(false)
?>
            ...
            <div class="pull-right">
                ...
                <a href="<?=Url::to(['research-knowhow-group/index']);?>" class="btn btn-danger">
                    ยกเลิก
                </a>
            </div>
