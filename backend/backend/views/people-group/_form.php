...
<div class="row setup-content" id="step-1">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'people_group_name')->textInput(['required' => 'required']) ?>

            <?= $form->field($model, 'people_group_name_en')->textInput(['maxlength' => true]) ?>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">  
                    ...
                    <?=
                    $form->field($model, 'people_group_detail')->widget(CKEditor::className(), [
                        'options' => ['row' => 6],
                        'preset' => 'basic',
                    ])->label(FALSE)
                    ?>     
                ...
                <div class="panel-body">   
                    ...
                    <?php
                    echo $form->field($model, 'people_group_detail_en')->widget(CKEditor::className(), [
                        'options' => ['row' => 6],
                        'preset' => 'basic',
                    ])->label(FALSE)
                    ?>     
            ...
            <div class="pull-right">
                ...
                <a href="<?= Url::to(['people-group/index']); ?>" class="btn btn-danger">
                    ยกเลิก
                </a>
            </div>
