        ...
        <div class="table-responsive">
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    //'people_group_name',
                    [
                        'attribute' => 'people_group_name',
                        'header' => 'ชื่อกลุ่ม',
                        'value' => function ($data) {
                            return $data->people_group_name;
                        }
                    ],
                    [
                        'attribute' => 'people_group_name_en',
                        'header' => 'ชื่อกลุ่มภาษาอังกฤษ',
                        'value' => function ($data) {
                            return $data->people_group_name_en;
                        }
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->people_group_id], [
