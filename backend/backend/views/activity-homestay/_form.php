...
<div class="activity-homestay-form">
    ...
    <?php echo $form->field($model, 'homestay_id')->widget(Select2::className(), [
            'data' => ArrayHelper::map(\app\models\Homestay::find()->where(['community_id' => $activity->community_id])->all(), 'homestay_id', 'homestay_name'),
            'language' => 'th',
