    ...
    <div class="panel-body">
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'homestay_id',
                    'value' => function($model) {
                        return $model->homestay->homestay_name;
                    }
                ],
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function($url, $model, $key) {
                            return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->activity_homestay_id], [
