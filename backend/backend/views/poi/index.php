...
$this->title = 'สถานที่ที่เกี่ยวข้อง';
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function($data) {
                        if ($data->poi_image_cover != "") {
                            $url = "@web/uploads/community/".$data->community_id.'/poi/' . $data->poi_image_cover;
                        } else {
                ...
                [
                    'attribute' => 'poi_group_id',
                    'header' => 'ชื่อกลุ่ม',
                    'value' => function($model) {
                        return $model->poiGroup->poi_group_name;
                    }
                ],
                [
                    'attribute' => 'poi_name',
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function($url, $model, $key) {
                            return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->poi_id], [
