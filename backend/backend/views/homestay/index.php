            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {                           
                            if ($data->homestay_image_cover != "") {
                                $url = "@web/uploads/community/" . $data->community_id . '/homestay/' . $data->homestay_image_cover;
                            } else {
                    ...
                    [
                        'attribute' => 'homestay_name',
                        'header' => 'ชื่อสถานที่',
                        'value' => function ($model) {
                            return $model->homestay_name;
                        }
                    ],
                    [
                        'attribute' => 'homestay_owner_name',
                        'header' => 'เจ้าของโฮมสเตย์',
                        'value' => function ($model) {
                            return $model->homestay_owner_name;
                        }
                    ],

                    [
                        'label' => 'เพิ่มภาพโฮมสเตย์',
                        'headerOptions' => ['style' => 'text-align: center;'],
                        'contentOptions' => ['style' => 'text-align: center;'],
                        'format' => 'raw',
                        'value' => function ($data) {
                            $url = Url::to([
                                'community-image/homestay-index',
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->homestay_id], [
