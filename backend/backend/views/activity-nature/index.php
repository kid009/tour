...
$this->title = 'กิจกรรมในสถานที่ธรรมชาติ';
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($model) {
                        return $model->nature->nature_name;
                    }
                ],
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function($url, $model, $key) {
                            return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->activity_nature_id], [
