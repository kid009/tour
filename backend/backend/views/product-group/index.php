        ...
        <div class="table-responsive">
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'product_group_name_en',
                        'header' => 'กลุ่มสินค้าภาษาอังกฤษ',
                        'value' => function ($model) {
                            return $model->product_group_name_en;
                        }
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->product_group_id], [
