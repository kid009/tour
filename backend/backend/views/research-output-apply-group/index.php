...
$this->title = 'กลุ่มการนำไปใช้ประโยชน์';
        ...
        <div class="table-responsive">
            ...
            echo GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'researcher_output_apply_group_en',
                        'header' => 'กลุ่มภาษาอังกฤษ',
                        'value' => function ($model) {
                            return $model->researcher_output_apply_group_en;
                        }
                    ],
                    [
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->researcher_output_apply_group_id], [
