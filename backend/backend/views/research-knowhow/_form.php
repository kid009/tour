...
<div class="row setup-content" id="step-1">
    <div class="col-xs-8 col-md-offset-2">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'researcher_knowhow_name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true])->label('ชื่อความรู้') ?>

            <?= $form->field($model, 'researcher_knowhow_name_en', ['enableAjaxValidation' => true])->textInput(['maxlength' => true])->label('ชื่อภาษาอังกฤษ') ?>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <?= $form->field($model, 'researcher_knowhow_detail')->widget(CKEditor::className(), [
                        'options' => ['rows' => 3],
                        'preset' => 'standard',
                    ])->label(false) ?>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <?= $form->field($model, 'researcher_knowhow_detail_en')->widget(CKEditor::className(), [
                        'options' => ['rows' => 3],
                        'preset' => 'standard',
                    ])->label(false) ?>
                </div>
        ...
        <div class="col-md-12">
            ...
            ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?= $form->field($model, 'researcher_knowhow_image_cover')->widget(FileInput::className(), [
                            'options' => [
                                'accept' => 'image/*',
                                'pluginOptions' => [
                                    'showUpload' => false,
            ...
            ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-3">
                            <?= Html::img('@web/uploads/research/knowhow/' . $model->researcher_knowhow_image_cover, ['style' => 'height:100px;weidth:100px;']) ?>
                            <br><br>
                        </div>
                        <div class="col-md-9">
                            <?php
                            echo $form->field($model, 'researcher_knowhow_image_cover')->widget(FileInput::className(), [
                                'options' => [
                                    'accept' => 'image/*',
                                    'pluginOptions' => [
                                        'showUpload' => false,
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <?= $form->field($model, 'researcher_knowhow_vdo')->textInput()->label('ลิงค์วีดีโอ') ?>

                    <?= $form->field($model, 'researcher_knowhow_link')->textInput()->label('ลิงค์') ?>
            ...
            <div class="pull-right">
                ...
                <a href="<?= Url::to(['research-knowhow/index']); ?>" class="btn btn-danger">
                    ยกเลิก
                </a>
            </div>
