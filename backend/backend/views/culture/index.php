            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            $url = "@web/uploads/community/" . $data->community_id . '/culture/' . $data->culture_image_cover;
                    ...
                    [
                        'attribute' => 'culture_group_id',
                        'header' => 'กลุ่มวัฒนธรรม',
                        'value' => function ($model) {
                            return $model->cultureGroup->culture_group_name;
                        }
                    ],
                    [
                        ...
                        'header' => 'วัฒนธรรม',
                        'value' => function ($model) {
                            return $model->culture_name;
                        }
                    ],
                    [
                        'attribute' => 'culture_name_en',
                        'header' => 'ชื่อภาษาอังกฤษ',
                        'value' => function ($model) {
                            return $model->culture_name_en;
                        }
                    ],

                    [
                        'label' => 'เพิ่มภาพวัฒนธรรม',
                        'headerOptions' => ['style' => 'text-align: center;'],
                        'contentOptions' => ['style' => 'text-align: center;'],
                        'format' => 'raw',
                        'value' => function ($data) {
                            $url = Url::to([
                                'community-image/culture-index',
                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['delete', 'id' => $model->culture_id], [
