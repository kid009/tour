...
use app\models\TourismStoryGroupSearch;
...
class TourismStoryGroupController extends Controller
{
    ...
    {
        $searchModel = new TourismStoryGroupSearch();
    ...
    {
        if (($model = TourismStoryGroup::findOne($id)) !== null) {
            return $model;
        }
