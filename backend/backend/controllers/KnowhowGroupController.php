...
use app\models\KnowhowGroupSearch;
...
class KnowhowGroupController extends Controller
{
    ...
    {
        $searchModel = new KnowhowGroupSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save()) {
                ...
                return $this->redirect(['index', 'id' => $model->knowhow_group_id]);
            }
        }
    ...
    {
        if (($model = KnowhowGroup::findOne($id)) !== null) {
            return $model;
        }
