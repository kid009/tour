...
use app\models\PlaceGroupSearch;
...
class PlaceGroupController extends Controller
{
    ...
    {
        $searchModel = new PlaceGroupSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->save()){
                ...
                return $this->redirect(['index', 'id' => $model->place_group_id]);
            }             
        }
    ...
    {
        if (($model = PlaceGroup::findOne($id)) !== null) {
            return $model;
        }
