...
use app\models\TourismKnowhowGroupSearch;
use Yii;
...
class TourismKnowhowGroupController extends Controller
{
    ...
    {
        $searchModel = new TourismKnowhowGroupSearch();
    ...
    {
        if (($model = TourismKnowhowGroup::findOne($id)) !== null) {
            return $model;
        }
