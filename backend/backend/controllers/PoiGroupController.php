...
class PoiGroupController extends \yii\web\Controller
{
    ...
    {
        $searchModel = new PoiGroupSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->save()){
                ...
                return $this->redirect(['index', 'id' => $model->poi_group_id]);
            }
        }
    ...
    {
        if (($model = PoiGroup::findOne($id)) !== null) {
            return $model;
        }
