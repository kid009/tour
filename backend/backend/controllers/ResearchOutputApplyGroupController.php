...
use app\models\ResearchOutputApplyGroupSearch;
...
class ResearchOutputApplyGroupController extends Controller
{
    ...
    {
        $searchModel = new ResearchOutputApplyGroupSearch();
    ...
    {
        $model = new ResearchOutputApplyGroup();
    ...
    {
        if (($model = ResearchOutputApplyGroup::findOne($id)) !== null) {
            return $model;
        }
