...
use app\models\ResearchTechnologyGroupSearch;
...
class ResearchTechnologyGroupController extends Controller
{
    ...
    {
        $searchModel = new ResearchTechnologyGroupSearch();
    ...
    {
        $model = new ResearchTechnologyGroup();
    ...
    {
        if (($model = ResearchTechnologyGroup::findOne($id)) !== null) {
            return $model;
        }
