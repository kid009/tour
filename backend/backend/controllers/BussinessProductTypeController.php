...
use app\models\BussinessProductTypeSearch;
use Yii;
...
class BussinessProductTypeController extends Controller
{
    ...
    {
        $searchModel = new BussinessProductTypeSearch();
    ...
    {
        $model = new BussinessProductType();
    ...
    {
        if (($model = BussinessProductType::findOne($id)) !== null) {
            return $model;
        }
