...
use app\models\BussinessProductCommunityGroupSearch;
...
class BussinessProductCommunityGroupController extends Controller
{
    ...
    {
        $searchModel = new BussinessProductCommunityGroupSearch();
    ...
    {
        $model = new BussinessProductCommunityGroup();
    ...
    {
        if (($model = BussinessProductCommunityGroup::findOne($id)) !== null) {
            return $model;
        }
