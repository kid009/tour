...
use app\models\ResearchKnowhowGroupSearch;
use Yii;
...
class ResearchKnowhowGroupController extends Controller
{
    ...
    {
        $searchModel = new ResearchKnowhowGroupSearch();
    ...
    {
        $model = new ResearchKnowhowGroup();
    ...
    {
        if (($model = ResearchKnowhowGroup::findOne($id)) !== null) {
            return $model;
        }
