...
class PostController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $data = $query->select('*')->from('post')
                ->leftjoin('topic', 'post.topic_id = topic.topic_id')
                ->where(['post_id' => $id])
                ->all();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            //save image
            $model->post_image = Yii::$app->Upload->Importimage($model, 'post', 'uploads/post/', 'post_image');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            //save image
            $model->post_image = Yii::$app->Upload->Updateimage($image_old, $model, 'post', 'uploads/post/', 'post_image');
    ...
    public function actionDelete($id)
    {
        ...
        if(!empty($model)){
            @unlink(Yii::getAlias('@webroot/uploads/post/'.$model->post_image));
        }
