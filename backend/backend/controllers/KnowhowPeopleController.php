...
use app\models\KnowhowPeopleSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\Session;

class KnowhowPeopleController extends Controller
{
    ...
    {
        $searchModel = new KnowhowPeopleSearch();
    ...
    public function actionCreate($knowhow_id)
    {
        $model = new KnowhowPeople();
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->save()){
                ...
                return $this->redirect(['knowhow/view', 'id' => $model->knowhow_id]);
            }
        }
    ...
    public function actionUpdate($id, $knowhow_id)
    {
        $model = $this->findModel($id);
    ...
    {
        if (($model = KnowhowPeople::findOne($id)) !== null) {
            return $model;
        }
