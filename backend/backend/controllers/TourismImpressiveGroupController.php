...
use app\models\TourismImpressiveGroupSearch;
use Yii;
...
class TourismImpressiveGroupController extends Controller
{
    ...
    {
        $searchModel = new TourismImpressiveGroupSearch();
    ...
    {
        $model = new TourismImpressiveGroup();
    ...
    {
        if (($model = TourismImpressiveGroup::findOne($id)) !== null) {
            return $model;
        }
