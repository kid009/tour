...
use app\models\ResearchTourismProductGroupSearch;
...
class ResearchTourismProductGroupController extends Controller
{
    ...
    {
        $searchModel = new ResearchTourismProductGroupSearch();
    ...
    {
        $model = new ResearchTourismProductGroup();
    ...
    {
        if (($model = ResearchTourismProductGroup::findOne($id)) !== null) {
            return $model;
        }
