...
use app\models\BussinessKnowhowGroupSearch;
use Yii;
...
class BussinessKnowhowGroupController extends Controller
{
    ...
    {
        $searchModel = new BussinessKnowhowGroupSearch();
    ...
    {
        $model = new BussinessKnowhowGroup();
    ...
    {
        if (($model = BussinessKnowhowGroup::findOne($id)) !== null) {
            return $model;
        }
