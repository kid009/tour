...
use app\models\ActivitySpecialGroupSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\Session;

class ActivitySpecialGroupController extends Controller
{
    ...
    {
        $searchModel = new ActivitySpecialGroupSearch();
    ...
    {
        $model = new ActivitySpecialGroup();
    ...
    {
        if (($model = ActivitySpecialGroup::findOne($id)) !== null) {
            return $model;
        }
