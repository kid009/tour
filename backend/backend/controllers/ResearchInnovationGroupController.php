...
use app\models\ResearchInnovationGroupSearch;
use Yii;
...
class ResearchInnovationGroupController extends Controller
{
    ...
    {
        $searchModel = new ResearchInnovationGroupSearch();
    ...
    {
        $model = new ResearchInnovationGroup();
    ...
    {
        if (($model = ResearchInnovationGroup::findOne($id)) !== null) {
            return $model;
        }
