...
use app\models\BussinessGroupSearch;
...
class BussinessGroupController extends Controller
{
    ...
    {
        $searchModel = new BussinessGroupSearch();
    ...
    {
        if (($model = BussinessGroup::findOne($id)) !== null) {
            return $model;
        }
