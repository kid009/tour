...
class TourismImage extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['tourism_type_id', 'ref_id'], 'integer'],
            [['create_date', 'update_date'], 'safe'],
            [['tourism_image_name', 'create_by', 'update_by'], 'string', 'max' => 200],           
            [
                ['tourism_image_file'], 'file',
                'skipOnEmpty' => true,
