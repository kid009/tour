 ...
 */
class KnowhowGroupSearch extends KnowhowGroup
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        // if ($session['user_login'] == 'admin') {
            $query = KnowhowGroup::find()->orderBy('update_date desc');
        // } 
        // else {
        //     $query = KnowhowGroup::find()->where(['create_by' => $session['user_login']])->orderBy('update_date desc');
        // }
